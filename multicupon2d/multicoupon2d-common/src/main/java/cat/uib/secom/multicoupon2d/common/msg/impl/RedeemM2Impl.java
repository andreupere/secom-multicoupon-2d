...
@Root(name=MessageTypesConstants.MULTIREDEEM_MESSAGE2)
public class RedeemM2Impl extends AbstractMSG implements RedeemM2 {

	
	public static String TYPE = MessageTypesConstants.MULTIREDEEM_MESSAGE2;

	
	/**
	 * Encrypted service provided by Merchant
	 * */
	@Element(name="service-encrypted")
	private String s;
	
	/**
	 * Ai,j,kj set as a String
	 * */
	...
	@Override
	public void setMerchantSignature(String mSignature) {
		this.merchantSignature = mSignature;
		
	}

	@Override
	public String getServiceEncrypted() {
		return this.s;
	}

	@Override
	public void setServiceEncrypted(String servEnc) {
		this.s = servEnc;
	}
	...
	public ASN1Object toASNObject(){
		...
		tmp.add(new DERGeneralString(s));
	...
	private boolean getValues(ASN1Sequence m2redeemASN){
		...
		s = ((DERGeneralString) m2redeemASN.getObjectAt(0)).getString();
		merchantSignature = ((DERGeneralString) m2redeemASN.getObjectAt(1)).getString();
		idR = ((DERGeneralString) m2redeemASN.getObjectAt(2) ).getString();
